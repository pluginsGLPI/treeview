...
### for using tx :
##tx set --execute --auto-local -r GLPI_treeview.glpi_treeview-version-162 'locales/<lang>.po' --source-lang en --source-file locales/glpi.pot
## tx push -s
## tx pull -a
